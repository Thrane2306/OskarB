...
public class JSONStrings {
	...
	public static String createEvent(String location, String createdBy,
			...
			String text) {
		String json = "{\"serialVersionUID\":1,\"overallID\":\"createEvent\",\"location\":\""
				+ location
				+ "\",\"createdby\":\""
				+ createdBy
				+ "\",\"start\":"
	...
	public static String getEventNote(String eventID) {
		String json = "{\"serialVersionUID\":1,\"overallID\":\"" + "getNote"
				+ "\",\"eventid\":\"" + eventID + "\"}";
		System.out.println(json);
		return json;
	}
	...
	public static String saveEventNote(String eventID, String text) {
		String json = "{\"serialVersionUID\":1,\"overallID\":\"" + "saveNote"
				+ "\",\"eventid\":\"" + eventID + "\",\"note\":\"" + text
				+ "\"}";
		return json;
	}
